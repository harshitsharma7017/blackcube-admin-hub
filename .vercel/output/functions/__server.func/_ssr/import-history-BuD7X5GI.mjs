...
import { _ as History, j as CircleAlert } from "../_libs/lucide-react.mjs";
...
import { n as importHistoryQuery } from "./queries-GmUgzXC-.mjs";
import { t as Route } from "./import-history-mElodLhp.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/import-history-BuD7X5GI.js
...
function ImportHistoryPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppShell, {
		...
		description: "View the log of all Excel and CSV imports.",
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Failed to load history" }),
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(History, { className: "size-6" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "No import history found." })]
						})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
							...
							children: item.totalRows
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
							className: "tabular-nums font-semibold text-success",
							children: item.importedRows
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
							className: "tabular-nums font-semibold text-destructive",
							children: item.failedRows
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: `inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${item.status === "Completed" ? "bg-success/15 text-success" : item.status === "Failed" ? "bg-destructive/15 text-destructive" : "bg-warning/15 text-warning"}`,
...
//#endregion
export { ImportHistoryPage as component };
